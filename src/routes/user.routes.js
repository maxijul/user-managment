...
import userUnregisterdDTO from '#Dto/user-unregister.dto.js';
...
// userJWTDTO es la autenticacion primero ese middleware antes que las validaciones
...
userRouter.delete('/unregister', userJWTDTO, userUnregisterdDTO, userUnregisterController);
